...
\begin{remark}
The word ``radical'' here should be understood as ``radical of a ring'',
which intuitively describes ``a set of bad elements of the ring''.
\end{remark}
...
\begin{definition}\label{defn:math120a:fall2025:lec3:field-of-fractions}
