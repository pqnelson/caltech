...
\begin{definition}
Let $\phi\colon A\to B$ be a morphism of [commutative unital] rings.
Let $P\in\Spec(A)$ and $Q\in\Spec(B)$ be prime ideals.
We say $Q$ \define{Lies Over} $P$ (or $P$ \emph{lies under} $Q$)
if $\phi^{*}(Q)=P$.

We usually view $B$ as an extension of $A$, and just write $Q\cap A$
for $\phi^{*}(Q)$.
\end{definition}

\begin{definition}\index{Lying over property}
Let $\phi\colon A\to B$ be a morphism of [commutative, unital] rings.
We say they satisfy the \define{Lying Over Property} if every prime
ideal $P$ of $A$ lies under some prime ideal $Q$ of $B$.
\end{definition}

\begin{definition}[Going-up property]\label{defn:going-up-property}\index{Going-up!Property}
...
\begin{definition}[Going-down property]\label{defn:going-down-property}\index{Going-down!Property}
Let $\phi\colon A\to B$ be a morphism of rings.
