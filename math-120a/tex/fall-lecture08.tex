...
\begin{fact}\label{artinian-rings-have-finitely-many-maximal-and-prime-ideals}
If $A$ is an Artinian ring, then $A$ has finitely many maximal ideals
(and by the previous corollary, $A$ has finitely many prime
ideals). See also Stacks project \href{https://stacks.math.columbia.edu/tag/00J7}{\texttt{[00J7]}}.
\end{fact}
