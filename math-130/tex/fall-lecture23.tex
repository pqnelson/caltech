...
The pullback $\pullback{f}\sheaf{G}:=f^{-1}\sheaf{G}\otimes_{f^{-1}\StructureSheaf_{Y}}\StructureSheaf_{X}$
is the \define{Pullback of $\sheaf{G}$ to $X$ by $f$}.
...
\begin{equation}
\begin{array}{ccccccc}
\sheaf{G}'_{f(p)} &\to & \sheaf{G}_{f(p)} & \to & \sheaf{G}''_{f(p)} &\to&0\\
\otimes_{\StructureSheaf_{Y,f(p)}} & &
\otimes_{\StructureSheaf_{Y,f(p)}} & &
\otimes_{\StructureSheaf_{Y,f(p)}} & &\\
\otimes_{\StructureSheaf_{X,p}} & &
\otimes_{\StructureSheaf_{X,p}} & &
\otimes_{\StructureSheaf_{X,p}} & &
\end{array}
\end{equation}
