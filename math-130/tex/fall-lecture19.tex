...
\begin{projective-dim-thm}[{Hartshorne~\cite[I.7.2]{hartshorne1977algebraic}}]
Let $Y$, $Z$ be irreducible closed varieties of dimensions $r$ and $s$ in $\PP^{n}$. Then
every irreducible component of $Y\cap Z$ has codimension at most $n$.
Furthermore, if $r+s\leq n$, then $Y\cap Z$ is nonempty.
\end{projective-dim-thm}
