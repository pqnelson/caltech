...
\begin{theorem}[Krull intersection]\marginpar{{\footnotesize Matsumara 11D}}\label{thm:math-120a:krull-intersection}\ignorespaces%
...
\begin{proof}
By Artin--Rees Theorem~\ref{math120a:artin--rees}, there exists an $r\in\NN$ such that for $n>r$,
\begin{subequations}
  \begin{align}
N&=I^{n}M\cap N\\
 &=I^{n-r}(I^{r}M\cap N)\\
