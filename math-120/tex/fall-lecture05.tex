...
(or just the ``\emph{Ring of Fractions}'' of $A$),
which Matsumara denoted by $\Phi(A)$.
\end{definition}

\begin{remark}
When $A$ is an integral domain, the ring of fractions of $A$ is equal to the
field of fractions of $A$ (\S\ref{defn:math120a:fall2025:lec3:field-of-fractions}). But for more general settings, the ring of
fractions remains well-defined whereas the field of fractions is not.
\end{remark}
