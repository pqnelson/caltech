...
The emphasis of this course will be on homology theory. (It appears to
be following Hatcher's \textit{Algebraic Topology}~\cite{hatcher2002algebraic}, Chapter 2.)
...
cylinder of $f\colon\sphere{1}\sqcup\sphere{1}\sqcup\sphere{1}\to G$. The three
