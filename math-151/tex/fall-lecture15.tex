...
\subsection{Eilenberg--Steenrod Axioms}\label{subsec:fall-2025:eilenberg-steenrod-axioms-for-homology}
...
\begin{theorem}\label{thm:eilenberg-steenrod:homology:uniqueness}
